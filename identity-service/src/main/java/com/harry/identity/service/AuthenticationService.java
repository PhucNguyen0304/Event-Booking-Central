...
import com.harry.identity.entity.InvalidatedToken;
...
import com.harry.identity.repository.InvalidatedTokenRepository;
...
public class AuthenticationService {
    ...
    private String generateToken(User user) {
        ...
        try {
            ...
            log.error("Canot create token", e);
    ...
    public void logout(LogoutRequest request) throws JOSEException, ParseException {
        log.info("Token in logout service " + request.getToken());
         try {
